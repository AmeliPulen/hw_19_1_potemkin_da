        ...
        <main class="row">
            ...
            <div class="col-12">
                <p class="d-inline-flex gap-1">
                    ...
                    <button class="l-100 btn btn-primary" type="button" data-bs-toggle="collapse"
                    ...
                    <div class="col">
                        <div class="collapse multi-collapse" id="multiCollapseExample1">
                            <div class="card card-body">
                                Чтобы купить товар, необходимо выбрать товар, оплатить товар и выбрать способ доставки
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="collapse multi-collapse" id="multiCollapseExample2">
                            <div class="card card-body">
                                Доставка осуществляется курьером или самовывозом
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="collapse multi-collapse" id="multiCollapseExample3">
                            <div class="card card-body">
                                Гарантию на товар смотрите в описании каждого товара
                            </div>
                        </div>
                    </div>
                </div>
